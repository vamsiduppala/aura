...
export function buildServer() {
  ...
  // Single-origin mode: if apps/web has been built, serve it from this same server so the whole
  // app lives behind one URL (needed anywhere only one port is public). Skipped in local dev.
