...
- [~] Ch 28 Techniques of Tajaka (16621–17264): muntha (progressed lagna 1 rasi/yr), the six
      ...
      day/night + 30° rule) + **all 35 tabled point-sahams of Table 74** — 28 planet/lagna-based
      via `computeSahams` (incl. Vivaha/Putra the Part 6 charts use; chained sahams in order,
      samartha & vanik verified vs Example 121) + the 7 bhava-cusp ones via `computeBhavaSahams`
      (Mrityu/Paradesa/Santapa/Karyasiddhi/Jalapatana/Apamrityu/Labha, incl. Karyasiddhi's
      day/night operand swap) → `data/sahams.ts`. API: /tajaka/saham, /tajaka/sahams,
      /tajaka/sahams-bhava. Table 74 complete.
